...
for step, (starting_index, ending_index) in steps.items():
    ...
    if step_name != '':
        ...
        if created_file_count > 0: files_df[c]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c.csv')
        if modified_file_count > 0: files_df[m]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/m.csv')
        if cma > 0: files_df[c & m & a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/cma.csv')
        if cm_a > 0: files_df[c & m & _a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/cm_a.csv')
        if cm__a > 0: files_df[c & m & __a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/cm__a.csv')
        if c_ma > 0: files_df[c & ~m & a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c_ma.csv')
        if c_m_a > 0: files_df[c & ~m & _a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c_m_a.csv')
        if c_m__a > 0: files_df[c & ~m & __a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/c_m__a.csv')
        if _cma > 0: files_df[~c & m & a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_cma.csv')
        if _cm_a > 0: files_df[~c & m & _a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_cm_a.csv')
        if _cm__a > 0: files_df[~c & m & __a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_cm__a.csv')
        if _c_ma > 0: files_df[~c & ~m & a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_c_ma.csv')
        if _c_m_a > 0: files_df[~c & ~m & _a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_c_m_a.csv')
        if _c_m__a > 0: files_df[~c & ~m & __a]["file_name"].to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/step-details/{step_name}/_c_m__a.csv')
...
files_df.to_csv(f'/home/runner/work/poi/poi/optimizing-ci-builds-ci-analysis/files.csv')
